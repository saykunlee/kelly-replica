<div id="app" style="width: 955px; margin: auto;">
	...
	<div v-else id="invoice" class='pd-10'>
		...
		<div class="d-flex mb-2">
			<div class="pd-10 wd-60p  flex-fill"><!-- logo area start  -->
				<div class="carousel slide" data-ride="carousel">
					<div class="carousel-inner">
						<div class="carousel-item active">
							<!-- brand-logo start -->
							<img :src="'/' + $app_estimate.lib_estimate.partner_info.image2" height="100" class="d-block mx-auto ">
							<!-- brand-logo end -->
						</div>
		...
		<div class="table-responsive mg-t-0">
			<table class="table table-invoice bd-b tx-nowrap mg-b-0">
				<thead>
					<tr class="bg-gray-100" style="border-top: 2px solid #99a0ae; border-bottom: 1px solid #99a0ae;">
						...
						<th v-if="estimate.is_open === '1'" class="wd-10p tx-center bd-r">요금</th>
						<th class="wd-10p tx-center bd-r">일수/인원</th>
						<th v-if="estimate.is_open === '1'" class="wd-10p tx-center">금액(페소)</th>
					</tr>
				</thead>
				<tbody>
					<!-- 숙박 -->
			...
			<table v-if="estimate.is_open === '1'" class="table table-invoice bd-b tx-nowrap">
				...
				<!-- 예약금 골프 -->
				<tr class="bg-gray-100" v-if="$app_estimate.lib_estimate.golf_amount > 0">
					<td class="tx-nowrap tx-left bd-r">
				...
				<!-- 예약금 1박 + 골프  -->
				<tr class="bg-gray-100" v-if="$app_estimate.lib_estimate.golf_amount > 0 && $app_estimate.lib_estimate.room_estimate.room_resfee > 0">
				...
				<tr class="">
					...
					<td class="tx-center tx-medium bd-r" colspan="5">
						<span class="tx-15 tx-medium">국민은행 정민석(인앤인) 165801-04-308286 </span>
					</td>
			...
			<table v-else class="table table-invoice bd-b tx-nowrap">
				...
				<tr style="border-top: 3px double #99a0ae;border-bottom: 3px double #99a0ae;">
					<td class="tx-nowrap tx-center ">
						<span class="tx-15 tx-bold">국민은행 정민석(인앤인) 165801-04-308286 </span>
					</td>
