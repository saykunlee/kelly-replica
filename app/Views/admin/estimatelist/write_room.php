		...
		<div class="row">
			<div class="col-lg-3 col-6">
				<div class="form-group">
					<label for="exp_date1" class="d-block">체크인</label>
					<input hidden type="text" id="exp_date1" name="exp_date" class="form-control tx-center wd-100p" placeholder="숙박일정">
					<input type="date" class="form-control tx-center full-width" placeholder="체크인" v-model="search.sel_exp_ci_date">
				</div>
			</div>
			<div class="col-lg-3 col-6">
				<div class="form-group">
					<label for="exp_date2" class="d-block">체크아웃</label>
			...
			<div class="col-lg-3 col-6">
				<div class="form-group flex-fill">
					<label for="commoncode_3_select" class="d-block">객실타입</label>
					<select class="custom-select " id="commoncode_3_select" v-model="search.sel_room_type_no">
						<option value="" selected>전체</option>
						<option v-for="(code,idx) in commoncode_6.list" :value="code.no">{{code.type_name}}</option>
					</select>
				</div>
			</div>
			<div class="col-lg-3 col-6">
				<div class="form-group flex-fill">
					<label for="commoncode_7_select" class="d-block">객실번호</label>
		<!-- 			<select class="custom-select " id="commoncode_7_select" v-model="search.sel_room_no">
						<option value="" selected>전체</option>
						<option v-for="(code,idx) in commoncode_7.list" :value="code.no">{{code.room_number}}</option>
					</select>
 -->
					<select class="custom-select " id="commoncode_7_select" v-model="search.sel_room_no">
						<option value="">객실을 선택하세요</option>
						<option v-for="room in filteredRoomList" :key="room.no" :value="room.no">
							{{ room.room_number }}
						</option>
					</select>
				</div>
